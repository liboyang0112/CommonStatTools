...
void EXOSTATS::AsymptoticsCLsRunner::runAsymptoticsCLs(const char* infile,
                                                       ...
                                                       double mu_inj)
{
   ...
   if (doInj) {
      RooDataSet* asimovData_inj = EXOSTATS::makeAsimovData(w, modelConfigName, conditionalExpected, obs_nll, 0, nullptr, nullptr, -999, true, mu_inj);
